...
(function() {
  ...
  fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, /** @lends fabric.Canvas.prototype */ {
    ...
    _getActionFromCorner: function(target, corner) {
      ...
      if (corner) {
        action = (corner === 'ml' || corner === 'mr')
          ? 'scaleX' : (corner === 'mt' || corner === 'mb')? 'scaleY': corner === 'tr'? 'rotate' : corner=='tl' ? 'delete' : corner=='br'?'scale':'scale';
      }
      return action;
    },
    ...
    getDeleteHandlerValue:function(){
    	return this.deleteFromHandler;
    },
    setDeleteHandlerValue:function(value){    	
    	this.deleteFromHandler = value;    	
    }
  });
...
(function(){
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, /** @lends fabric.Canvas.prototype */ {
      ...
      target && target.fire('mousedown', { e: e });
       if(this._currentTransform)
	     if (this._currentTransform.action === 'delete') {
	     	   this.deleteFromHandler = true;
               canvas.remove(this._currentTransform.target);
			   //$('#Delete_obj , .pop-page-cover ').fadeIn(1000);			   
		   }
    },
    ...
    /**
     * @private
     * @param {Event} e Event fired on mousemoveg
     */
    ...
    {
	  return cursorMap[cursorOffset[corner]];
    }
  });
})();
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
	...
	/**
     managing border Color
     */
	outlineColor: '',
		
/**
     managing border Width
     */
	outlineWidth: 0,
	/**
     managing textPrice
	...
	textColorPrice: 0,
	/**
     managing textOutlinePrice
     */
	textOutlineColorPrice: 0,
	/**
    storing resize Value
     */
	resizeValue:1,
	...
	originalImageDrawWidth:0,
	originalImageDrawHeight:0,
	originalImageDrawLeft:0,
	originalImageDrawTop:0,
    ...
    stateProperties:  (
      ...
      'stroke name url rot arc distortValue maxW maxH imgType align shapeType imgCatId originalSrc imgSubCatId fontTitle convert1Flag colorable clipUpload outlineIndex shapeSettingIndex shapeSelectIndx shapeSettingType roofGravity changeFontImageUrl arcRotate selectedFontCategoryIndex originalRatHeight originalRatWidth originalRatLeft originalRatTop originalImageDrawWidth originalImageDrawHeight originalImageDrawLeft originalImageDrawTop clipTitle effectUrl fontSelectedIndx  fontID convertSrc colorTitle outlineType layerIndx  fontTTF Bold Italic textIndx uploadColorArr font text globalTextName text_color strokeWidth strokeDashArray strokeLineCap strokeLineJoin strokeMiterLimit ' +
      'angle opacity fill fillRule shadow clipTo visible backgroundColor fontSizeValue arc_Value customEffectName outlineColor outlineWidth textColorPrice outlineColorTitle textOutlineColorPrice resizeValue'+
      'originalImageWidth originalImageHeight maxResizeValue'
    ).split(' '),
    ...
    toObject: function(propertiesToInclude) {
      ...
      var object = {
        ...
        name:				this.name,
        fontID:           	this.fontID,
        fontSelectedIndx:    this.fontSelectedIndx,
        effectUrl:          this.effectUrl,
        originalImageDrawHeight:   this.originalImageDrawHeight,
        originalImageDrawWidth:    this.originalImageDrawWidth,
        originalImageDrawLeft:     this.originalImageDrawLeft,
        originalImageDrawTop:      this.originalImageDrawTop,
        clipTitle:                 this.clipTitle,
        originalRatHeight:   this.originalRatHeight,
        originalRatWidth:    this.originalRatWidth,
        originalRatLeft:     this.originalRatLeft,
        originalRatTop:      this.originalRatTop,
        shapeSettingType:     this.shapeSettingType,
        changeFontImageUrl:		this.changeFontImageUrl,
        selectedFontCategoryIndex: this.selectedFontCategoryIndex,
        arcRotate:            this.arcRotate,
        roofGravity:          this.roofGravity,
        shapeSelectIndx:      this.shapeSelectIndx,
        outlineIndex:        this.outlineIndex,
        clipUpload:         this.clipUpload,
        colorable:          this.colorable,
        convertSrc:         this.convertSrc,
        convert1Flag:       this.convert1Flag,
        layerIndx:          this.layerIndx,
        ...
        originalSrc:        this.originalSrc,
         ...
         Bold:           	this.Bold,
          ...
          arc:           	this.arc,
          rot:           	this.rot,
          distortValue:     this.distortValue,
          Italic:           this.Italic,
        textIndx:           this.textIndx,
        uploadColorArr:     this.uploadColorArr,
        font:				this.font,
         text:				this.text,
        text_color:			this.text_color,
		globalTextName:   	this.globalTextName,
		url:				this.url,
		maxW:				this.maxW,
		maxH:				this.maxH,
		imgType:			this.imgType,
		imgCatId:			this.imgCatId,
		imgSubCatId:		this.imgSubCatId,
        flipX:              this.flipX,
        flipY:              this.flipY,
        ...
        arc_Value:			this.arc_Value,
        customEffectName:   this.customEffectName,
        outlineColor:       this.outlineColor,
        shapeSettingIndex:	this.shapeSettingIndex,
        outlineWidth:       this.outlineWidth,
        textColorPrice:		this.textColorPrice,
        textOutlineColorPrice:this.textOutlineColorPrice,
        outlineColorTitle:this.outlineColorTitle,
        resizeValue:		this.resizeValue,
        maxResizeValue:		this.maxResizeValue,
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
	...
	{	
     ...
     else
     {
     	...
     	this.scaleX=1;
     	this.scaleY=1;
     	this.currentWidth =scaleRatioWidth;
      	this.currentHeight = scaleRatioHeight;
     }
...
(function(){
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
    ...
    drawControls: function(ctx) {
      ...
      // top-left
       _left = this.flipX?(left + width - scaleOffsetX + strokeWidth2 + paddingX):(left - scaleOffsetX - strokeWidth2 - paddingX);
      _top = this.flipY?(top + height + scaleOffsetSizeY + strokeWidth2 + paddingY):(top - scaleOffsetY - strokeWidth2 - paddingY);

      this._drawControl('tl', ctx, methodName,_left, _top,left_resize);
      // top-right
      _left = this.flipX?(left - scaleOffsetX - strokeWidth2 - paddingX):(left + width - scaleOffsetX + strokeWidth2 + paddingX);
      _top = this.flipY?(top + height + scaleOffsetSizeY + strokeWidth2 + paddingY):(top - scaleOffsetY - strokeWidth2 - paddingY);
      this._drawControl('tr', ctx, methodName, _left,_top,topRightImage);

      // bottom-left
      _left = this.flipX?(left + width + scaleOffsetSizeX + strokeWidth2 + paddingX):(left - scaleOffsetX - strokeWidth2 - paddingX);
      _top = this.flipY?(top - scaleOffsetY - strokeWidth2 - paddingY):(top + height + scaleOffsetSizeY + strokeWidth2 + paddingY);

      this._drawControl('tr', ctx, methodName, _left,_top,right_resize);

      // bottom-right
       _left = this.flipX?(left - scaleOffsetX - strokeWidth2 - paddingX):left + width + scaleOffsetSizeX + strokeWidth2 + paddingX;
      _top = this.flipY?(top - scaleOffsetY - strokeWidth2 - paddingY):(top + height + scaleOffsetSizeY + strokeWidth2 + paddingY);

      this._drawControl('br', ctx, methodName,_left,_top,bottmRightImage);
      ...
      if (!this.get('lockUniScaling')) {
        ...
        this._drawControl('mt', ctx, methodName,_left,_top,bottom_up_resize);
        ...
        this._drawControl('mb', ctx, methodName,_left, _top,bottom_up_resize);
        ...
        this._drawControl('mb', ctx, methodName,  _left,  _top,left_right_resize);
        ...
        _top = top + height/2 - scaleOffsetY;
        this._drawControl('ml', ctx, methodName, _left,_top,left_right_resize);
    ...
    _drawControl: function(control, ctx, methodName, left, top,drawHandlerImg) {
      ...
      if (this.isControlVisible(control)) {
       ...
       // ctx[methodName](left, top, sizeX, sizeY);
        ctx.drawImage(drawHandlerImg, left, top, sizeX, sizeY);
      }
    },
...
(function(global) {
  ...
  fabric.Image = fabric.util.createClass(fabric.Object, /** @lends fabric.Image.prototype */ {
    ...
    initialize: function(element, options) {
      ...
      if (options.filters) {
       ...
       //console.log(colorPickerValue)
         //global_SelectedItem.applyFilters();
      }
    },
    ...
    {	
      ...
      alert("Product does not exist for this color")
    },
