(function (window, $, undefined) {
    ...
    function paletteTemplate (p, color, className) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            html.push('<span title="' + tiny.toHexString() + '" data-color="' + tiny.toRgbString() + '" class="' + c + '"><span id="lastSpan" class="sp-thumb-inner" style="' + swatchStyle + ';" /></span>');
        }
        ...
        function initialize() {
            ...
            chooseButton.bind("click.spectrum", function (e) {
				...
				//////////////////////////custom code/////////////////////////
					...
					//canvas.backgroundColor = $('.sp-thumb-active span#lastSpan').css("background-color");
					//canvas.renderAll();
					//console.log(dataLessJson[current_view][undoredoVar[current_view][0]]);
					//updateUndoRedo();
					//console.log(dataLessJson[current_view][undoredoVar[current_view][0]]);
				//////////////////////////////////////////////////////////////
    ...
    */
    ...
    $.fn.spectrum = function (opts, extra) {
        ...
        if (typeof opts == "string") {
            if (opts == "get") {
                return sparx[this.eq(0).data(dataID)].get();
            } else if (opts == "container") {
                return sparx[$(this).data(dataID)].container;
            }

            return this.each(function () {
                var spect = sparx[$(this).data(dataID)];
                if (spect) {
