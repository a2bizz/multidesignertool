 ...
 */
class A2bizz_Designer_Block_Catalog_Product_View_Media extends Mage_Catalog_Block_Product_View_Abstract
{	
    /**
    ...
    {
		echo 'A2bizz_Designer_Block_Catalog_Product_View_Media';exit;
        if ($image) {
