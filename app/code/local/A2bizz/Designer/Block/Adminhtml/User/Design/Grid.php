...
class Sparx_Designersoftware_Block_Adminhtml_User_Design_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('email', array(
          'header'    => Mage::helper('designersoftware')->__('Email'),
          'align'     =>'left',
          'index'     => 'email',
      ));
	  ...
	  */
	  ...
	  $this->addColumn('filename', array(
          ...
          'sortable'	=>false,
          'width'		=>100,
          'renderer'	=> 'Sparx_Designersoftware_Block_Adminhtml_User_Design_Renderer_Image',
      ));
