...
class Sparx_Designersoftware_Block_Adminhtml_Designersoftware_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('designersoftware_form', array('legend'=>Mage::helper('designersoftware')->__('Design information')));
