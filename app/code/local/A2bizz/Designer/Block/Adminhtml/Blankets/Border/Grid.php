...
class Sparx_Designersoftware_Block_Adminhtml_Blankets_Border_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
	  parent::__construct();
      $this->setId('borderGrid');
      $this->setDefaultSort('border_id');
  ...
  {
      $collection = Mage::getModel('designersoftware/blankets_border')->getCollection();
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('designersoftware')->__('Border Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
	  ...
	  */
	  ...
	  $this->addColumn('drop_image', array(
          ...
          'sortable'	=>false,
          'width'		=>100,
          'renderer'	=> 'Sparx_Designersoftware_Block_Adminhtml_Blankets_Border_Renderer_Dropdown_Image',
      ));
    ...
    {
        $this->setMassactionIdField('border_id');
        $this->getMassactionBlock()->setFormFieldName('border');
