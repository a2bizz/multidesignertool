...
class Sparx_Designersoftware_Block_Adminhtml_Template_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('designersoftware/template')->getCollection();
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('design_name', array(
          'header'    => Mage::helper('designersoftware')->__('Design Name'),
          'align'     =>'left',
          'index'     => 'design_name',
      ));
	  ...
	  */
	  ...
	  $this->addColumn('design_file', array(
          'header'    => Mage::helper('designersoftware')->__('Template Image'),
          'align'     =>'left',
          'index'     => 'design_file',
          'filter'		=>false,
          'sortable'	=>false,
          'width'		=>100,
          'renderer'	=> 'Sparx_Designersoftware_Block_Adminhtml_Template_Renderer_Image',
      ));
            ...
            array(
                ...
                'actions'   => array(
                    array(
                        ...
                        'url'       => Mage::getUrl('designersoftware/index/index/?tid=id'), 
                        'field'     => 'id'
                    )
                ),
                'filter'    => false,
                ...
                'index'     => 'stores',
                'is_system' => true,
                'renderer'	=> 'Sparx_Designersoftware_Block_Adminhtml_Template_Renderer_Action',
        ));
  ...
  {
      return Mage::getBaseUrl().'designersoftware/index/index/?tid='.$row->getId().'&type=edit';
  }
