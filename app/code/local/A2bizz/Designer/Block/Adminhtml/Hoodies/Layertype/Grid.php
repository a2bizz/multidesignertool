...
class Sparx_Designersoftware_Block_Adminhtml_Hoodies_Layertype_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
	  parent::__construct();
      $this->setId('layertypeGrid');
      $this->setDefaultSort('layertype_id');
  ...
  {
      $collection = Mage::getModel('designersoftware/hoodies_layertype')->getCollection();
  ...
  {
      $this->addColumn('layertype_id', array(
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('designersoftware')->__('Layer Type Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
    ...
    {
        $this->setMassactionIdField('layertype_id');
        $this->getMassactionBlock()->setFormFieldName('layertype');
