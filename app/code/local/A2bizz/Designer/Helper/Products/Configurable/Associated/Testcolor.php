...
class Sparx_Designersoftware_Helper_Products_Configurable_Associated_Testcolor extends Mage_Core_Helper_Abstract
{
			...
			foreach($colorIdObject->options as $obj):
				...
				if($_minSalQty < 6){
					...
					if($checkFirstColor==0){
						//Mage::register('defaultAssociatedColor',$colorCode);
						$this->defaultAssociatedColor($colorId);
						$checkFirstColor++;
					} 
