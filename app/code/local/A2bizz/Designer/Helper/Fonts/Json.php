...
class Sparx_Designersoftware_Helper_Fonts_Json extends Mage_Core_Helper_Abstract {
    ...
    public function load($data) {
        ...
        foreach ($fontsCollection as $fonts) {
            ...
            $array['ttf'] = Mage::getBaseDir() . '/media/files/font/ttf/' . substr($fonts->getFilename(), 0, -3) . 'ttf';
            $array['isDefault'] = Mage::helper('designersoftware')->isDefaultFont($fonts->getFontsId());
            $fontArray[] = $array;
        }
    ...
    public function getNumberFonts() {
