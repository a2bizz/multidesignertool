<?php
class Sparx_Designersoftware_Hoodies_IndexController extends Mage_Core_Controller_Front_Action
{
	...
	public function swapItemAction(){		
		$return = Mage::helper('designersoftware/hoodies_product_json')->load($this->getRequest()->getPost());	
